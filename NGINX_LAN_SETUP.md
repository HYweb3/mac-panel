...
1. **在服务器上测试**：
```bash
curl http://192.168.1.77:8080
# 或
curl http://localhost:8080
```

2. **在局域网其他设备上测试**：
   - 手机/电脑浏览器访问：`http://192.168.1.77:8080`
   - 或使用您的域名
...
1. **查看站点配置**：
   - 访问 http://192.168.1.77:5173/nginx
   - 查看站点列表
   - 点击"查看配置"检查配置内容
...
- Nginx：http://192.168.1.77:80 (或 8080)
